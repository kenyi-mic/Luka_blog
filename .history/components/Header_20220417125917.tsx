...
function Header() {
  return (
    ...
    <div>
     <h1>
       Luka Garang's blog is the place to share your ideas with the world, whether being business, technology or awearness. It's time to grow together.
     </h1>
     <img className="w-44" src="/image.png" alt="" />
    </div>
    </div>
