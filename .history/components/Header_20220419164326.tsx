...
function Header() {
  return (
      <div>
     <header className="flex justify-between px-5 lg:gap-6 md:gap:3 max-w-7xl mx-auto">
      <div className="flex items-center space-x-5">
          ...
          <div className=" hidden md:inline-flex items-center space-x-5 justify-center max-w-6xl">
            <input type="text"  className=" h-5 rounded-full"/>
          </div>
