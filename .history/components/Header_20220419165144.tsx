  ...
  return (
     ...
     <header className="flex justify-around px-5 lg:gap-6 md:gap:3 max-w-7xl mx-auto">
      <div className="flex items-center space-x-5">
          ...
          <div className=" hidden md:inline-flex items-center space-x-5 justify-center bg-white border border-amber rounded-full p-1">
            <input type="text"  className=" h-10 mx-auto w-72 outline-none rounded-full"/>
          </div>
