    ...
    <header className="flex ">
      <div className="flex items-center space-x-5">
          ...
          <div className="hidden md:inline-flex items-center space-x-5 text-xl">
              ...
              <h3 className="text-white bg-gradient-to-br from-amber-600  to-yellow-600 py-1 px-4 rounded-full cursor-pointer">Follow</h3>
          </div>

      </div>
      <div className="md:inline-flex items-center  space-x-5 text-orange-600 text-xl">
          <h3>Sign In</h3>
