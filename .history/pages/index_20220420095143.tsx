...
{/* Main page*/}
 ...
 {/*left*/}
  <div className="px-10 space-y-5">
     ...
     <h2 className="text-2xl  max-w-2xl">It's time to shape your thoughts and learn something the best way, here we add all necessary information you may need to get started as a <span className="text-gray-800 hover:text-amber-400 cursor-pointer">business</span> person.</h2>
     <button className="text-xl font-bold  bg-gradient-to-br from-amber-600 to-yellow-500 items-center justify py-2 px-4 rounded-full cursor-pointer my-10 text-white  hover:text-gray-400">Sign up</button>
