  ...
  return (
    <div>
      ...
      <div className="max-w-6xl mx-auto py-10 ">
        ...
        {/*Books */}
        <div className="w-80 border border-cyan-700 overflow-hidden transition-all duration-1000 ease-in-out my-10">
          {books.map((book) => ( 
            <Link key={book._id} href={`/book/${book.slug.current}`}>
              <div>
                <img className="hover:scale-105 " src={urlFor(book.mainImage).url()!} alt={book.title} />
