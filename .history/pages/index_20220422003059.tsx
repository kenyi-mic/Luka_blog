...
{/* Main page*/}
 ...
 {/*left*/}
  <div className="px-10 space-y-5">
     ...
     <h2 className="text-2xl  max-w-2xl">Do you want to discover the mind of the world's most  <span className="text-gray-800 hover:text-amber-400 cursor-pointer">successful</span> people?</h2>
