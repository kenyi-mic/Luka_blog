        ...
        <div className="flex justify-between items-center bg-gradient-to-br from-amber-600 to-yellow-500 border-y border-black py-10  ">
          ...
          <div className="px-10 space-y-5">
            ...
            <Link href="./account/register">
              <button className="text-xl font-bold  dark:bg-gradient-to-br from-indigo-600 to-purple-500 bg-gradient-to-br from-amber-600 to-yellow-500 items-center justify py-2 px-4 rounded-full cursor-pointer my-10 text-white dark:text-indigo-300 hover:text-gray-400">
                Sign up
              </button>
            </Link>
          </div>
