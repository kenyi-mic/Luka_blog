...
{/* Main page*/}
 ...
 {/*left*/}
  <div className="px-10 space-y-5">
     ...
     <button className="text-xl font-bold font-serif bg-gradient-to-br from-amber-600 to-yellow-500 py-2 px-4 rounded-full cursor-pointer my-10">Sign up</button>
