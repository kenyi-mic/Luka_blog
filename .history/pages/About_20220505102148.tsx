              ...
              <div>
                ...
                <div className="flex flex-col-1 justify-between">
                  <div>
                    ...
                    <p className="font-extralight">{book.description}</p>
                    <p className="font-bold">{book.link}</p>
                  </div>
                  <div>
                  <img className="w-10 rounded-full " src={urlFor(book.author.image).url()!} alt={book.author.name} />
