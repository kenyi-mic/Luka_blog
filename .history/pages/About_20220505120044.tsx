          ...
          {books.map((book) => ( 
            <Link key={book._id} href={`/book/${book.slug.current}`}>
              <div className="border shadow-purple-200 shadow-lg overflow-hidden  my-10 group cursor-pointer">
                <img className="group-hover:scale-105 transition-transform  duration-1000 ease-in-out w-full h-96  object-cover" src={urlFor(book.mainImage).url()!} alt={book.title} />
