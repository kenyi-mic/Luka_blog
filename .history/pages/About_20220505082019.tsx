      ...
      <div className="max-w-6xl mx-auto py-10 ">
        ...
        <div className="grid grid-col lg:grid-cols-4 md:grid-cols-2 py-10 lg:gap-6 md:gap-3 max-w-7xl mx-auto">
         ...
         <div className="bg-gray-200 rounded p-5 shadow shadow-indigo-300 w-64 mx-auto my-5">
           ...
           <p className="text-sm text-gray-400">Book for building your mental intellenges</p>
           <Link href="https://www.amazon.com/Think-Grow-Rich-Napoleon-Hill/dp/0785833528" passHref>
           <a target='_blank'>
           <h4 className="text-xs text-amber-600 text-light cursor-pointer hover:text-blue-500">www.thinkandgrowrich.com</h4>
           </a>
           </Link>
