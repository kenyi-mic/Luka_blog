...
function contact() {
  return (
    <div className="dark:bg-slate-800 dark:text-gray-50 bg-blue-200 h-2/4">
      <Header />
      <hr />
      <main className="grid">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 p-2 md:p-6 lg:gap-6">
          ...
          <form className="rounded-lg shadow-xl flex flex-col px-8 py-8 bg-white dark:bg-blue-900">
