...
function footer() {
  return (
    <div>
      <div className="grid grid-col-1 md:grid-cols-4 lg:grid-cols-4 max-w-6xl mx-auto pt-10 my-10">
       {/* first*/}
      ...
      <div className="flex flex-1 flex-col">
       ...
       <div className="flex flex-1 flex-col">
        ...
        <h4>Join the blog</h4>
        <h4>Donate</h4>
        <h4>Our slack teamgvhgjjhhjhjhjhjhjhjhjhjhhhjjhhjhjhjhhhjhjhhhhhhjhjhjhhhjhjhjhjh</h4>
