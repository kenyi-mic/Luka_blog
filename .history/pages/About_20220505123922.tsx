          ...
          {books.map((book) => ( 
            <Link key={book._id} href={`/book/${book.slug.current}`}>
              <div className="border rounded-lg group cursor-pointer">
                <img className="h-4/5 w-full object-cover group-hover:scal-105 transition-transform duration-200 ease-in-out" src={urlFor(book.mainImage).url()!} alt={book.title} />
