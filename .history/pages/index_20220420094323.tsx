...
{/* Main page*/}
 ...
 {/*left*/}
  <div className="px-10 space-y-5">
     ...
     <button className="text-xl font-bold  bg-gradient-to-br from-amber-600 to-yellow-500 items-center justify py-2 px-4 rounded-full cursor-pointer ">Sign up</button>
