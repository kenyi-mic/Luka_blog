      ...
      <div className="max-w-6xl mx-auto py-10 ">
        ...
        <div className="grid grid-col lg:grid-cols-4 md:grid-cols-2 py-10 lg:gap-6 md:gap-3 max-w-7xl mx-auto">
         ...
         <div className="bg-gray-200 rounded p-5 shadow shadow-indigo-300 w-64 mx-auto my-5">
           <img className=" hover:scale-105 transition duration-500 overflow-hidden" src={urlFor(book.mainImage).url()!} alt="Think and grow rich" />
           ...
           <a target='_blank'>
           <h4 className="text-xs text-amber-600 text-light cursor-pointer hover:text-blue-500">{book.link}</h4>
           </a>
           </Link>
