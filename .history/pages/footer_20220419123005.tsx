    ...
    <div className="bg-blue-900">
      ...
      <div className=" text-gray-400 ">
       ...
       <div className=" text-gray-400 ">
        ...
        <h4><InstagramIcon className="mr-1"/>Instagram</h4>
        <h4><TwitterIcon className="mr-1"/>Twitter</h4>
        ...
        <h4 className="flex"><svg className="h-6 w-6 mr-1 items-center justify-center pt-2" href="/discord.svg" alt="" />Discord</h4>
