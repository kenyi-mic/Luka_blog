    ...
    <div className="bg-blue-900">
      ...
      <div className=" text-gray-400 ">
       ...
       <div className=" text-gray-400 ">
        ...
        <h4><FacebookIcon className="mr-1 text-blue-700 font-extrabold"/>Facebook</h4>
        <h4><InstagramIcon className="mr-1 bg-gradient-to-tr from-yellow-500 via-pink-600 to-purple-500 rounded text-gray-100 font-bold "/>Instagram</h4>
