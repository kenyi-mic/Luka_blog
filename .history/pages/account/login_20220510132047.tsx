...
function login() {
  return (
    <main>
      ...
      <Header />
      <hr />
      <div className="grid grid-col-1 md:grid-cols-2 lg:grid-cols-2 gap-3 lg:gap-6 bg-gradient-to-br from-pink-900 to-purple-900">
        <div className="bg-[url('/image/login.jpg')] text-gray-300 bg-cover p-10">
