...
const Register: React.FC = () => {
  ...
  return (
    <div className="col-md-12  h-screen">
      <div className="card card-container shadow-lg w-2/3 mx-auto my-24 p-12">
        <img 
          ...
          <Form>
            {!successful && (
              <div className="">
                ...
                <div className="form-group">
                  <button type="submit" className="btn btn-primary btn-block text-xl text-slate-200 bg-amber-500 ">Sign Up</button>
                </div>
              </div>
            )}
            {message && (
