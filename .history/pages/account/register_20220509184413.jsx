    ...
    return (
        <main>
            ...
            <div className="card my-10 lg:w-2/5 sm:w-4/5 md:w-2/3 mx-auto  p-3">
                <h4 className="card-header text-2xl text-center font-semibold">Sign Up</h4>
                <div className="card-body">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="form-group  mb-5">
                            <label className="my-5 text-xl text-gray-700">First Name:</label>
                            <input name="firstName" type="text" className="block  p-2 w-full outline-none border-slate-200 border" {...register('firstName')} id={`form-control ${errors.firstName ? 'is-invalid' : ''}`} />
                        ...
                        <div className="form-group mb-5">
                            ...
                            <input name="lastName" type="text" className="block  p-2 w-full outline-none border-slate-200 border" {...register('lastName')} id={`form-control ${errors.lastName ? 'is-invalid' : ''}`} />
                        ...
                        <div className="form-group mb-5">
                            ...
                            <input name="username" type="text" className="block  p-2 w-full outline-none border-slate-200 border" {...register('username')} id={`form-control ${errors.username ? 'is-invalid' : ''}`} />
                        ...
                        <div className="form-group">
                            ...
                            <input name="password" type="password"block className="block p-2 w-full outline-none border-slate-200 border" {...register('password')} id={`form-control ${errors.password ? 'is-invalid' : ''}`} />
                        ...
                        <Link href="/account/login" className="btn btn-link mt-10 bg-amber-600 text-white text-xl py-2 px-4 ml-2">Cancel</Link>
                        </div>
                    </form>
                </div>
            </div>
