  ...
  return (
    <main>
      ...
      <div className="grid grid-col-1 md:grid-cols-2 lg:grid-cols-2 gap-3 lg:gap-6 bg-gradient-to-br from-purple-300 to-indigo-400">
        ...
        <div className="border w-[90] mx-auto justify-center bg-red-600">
          <form className="border" action="">
            ...
            <div className="pb-5">
              ...
              <input
                type="text"
                className="block w-full outline-none rounded text-xl border-blue-400 border-2 p-1"
                name="username"
              />
            </div>
            <div className="pb-5">
              ...
              <input
                type="password"
                className="block w-full outline-none rounded text-xl border-blue-400 border-2 p-1s"
                name="password"
              />
            </div>
