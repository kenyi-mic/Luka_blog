...
function login() {
  return (
    <main>
      ...
      <Header />
      <hr />
      <div className="grid grid-col-1 md:grid-cols-2 lg:grid-cols-2 gap-3 lg:gap-6 bg-gradient-to-b from-blue-900 to-pink-900 p-10">
        <div className="bg-[url('/image/login.jpg')] text-gray-300 bg-cover bg-opacity-70 flex justify-center items-center">
          <div>
        ...
        <div className="flex flex-row items-center justify-content w-full mx-auto ">
          <form className="border px-5  mx-auto" action="">
            <h1
            ...
            <div className="pb-5">
              ...
              <input
                type="text"
                className="block w-full outline-none rounded text-xl border-blue-400 border-2 "
                name="username"
              />
            </div>
            <div className="pb-5">
