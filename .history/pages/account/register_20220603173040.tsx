            ...
            {!successful && (
              <div className="">
                <div className="form-group ">
                  ...
                  <Field name="username" type="text" className="form-control w-full h-10" />
                  <ErrorMessage 
                    name="username"
                    component="div"
                ...
                <div className="form-group">
                  ...
                  <Field name="email" type="email" className="form-control w-full h-10" />
                  <ErrorMessage
                    name="email"
                    component="div"
                ...
                <div className="form-group">
                  ...
                  <Field
                    name="password"
                    type="password"
                    className="form-control w-full h-10 outline-none font-bold"
                  />
                  <ErrorMessage
                    name="password"
                    component="div"
