            ...
            <div className="card grid grid-cols-1 gap-3 lg:gap-6 lg:w-2/4 mx-auto my-10">
                ...
                <div className="card-body">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Link href="/account/register" className="btn btn-link ml-2 py-2 px-4 bg-blue-500 text-gray-100">Don't have account? <span className="text-indigo-700">Sign up</span></Link>
                        </div>
