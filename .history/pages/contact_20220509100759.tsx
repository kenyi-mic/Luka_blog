    ...
    <div>
      ...
      <main className="grid">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 p-2 md:p-6 lg:gap-6">
          ...
          {/*Middle */}
          <div>
            <h2>For urgent information, check this out.</h2>
            <p>
              Email: <a href="mailto:">lukagarang011@gmail.com</a>
            </p>
            <p>Phone: <a href="tel:">+880181234567890</a></p>
            <p>Address: <a href="address">4051 St francisco Us</a>/p>
          </div>
