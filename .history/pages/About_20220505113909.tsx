          ...
          {books.map((book) => ( 
            <Link key={book._id} href={`/book/${book.slug.current}`}>
              <div className="border border-cyan-700 overflow-hidden  my-10 group cursor-pointer">
                <img className="group-hover:scale-105 transition-transform px-2 duration-1000 ease-in-out w-80 object-cover" src={urlFor(book.mainImage).url()!} alt={book.title} />
