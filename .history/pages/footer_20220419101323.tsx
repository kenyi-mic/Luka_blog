...
function footer() {
  return (
    <div className="bg-blue-900">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 p-2 md:p-6 max-w-6xl mx-auto sm:flex sm:items-center sm:max-w-7xl sm:mx-auto">
       {/* first*/}
