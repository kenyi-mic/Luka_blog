...
const footer = () => {
  ...
  return (
    <div className="bg-amazon_blue ">
      <h3 className="link hover:underline-none bg-amazon_blue-light text-bold grid grid-cols-1 place-items-center p-4 text-sm text-white">
        {' '}
        Back to top
      </h3>
      <div className="w-100% m-auto grid grid-flow-row-dense grid-cols-4 p-10 text-white">
        <div>
      ...
      <div className="flex flex-col-reverse divide-y divide-y-reverse divide-gray-400 ">
        <p className="grid grid-cols-1 place-items-center  p-5">
          <Image
            onClick={() => router.push('/')}
        ...
        <p
          ...
          className="link grid grid-cols-1  place-items-center p-5 text-gray-400 hover:text-white"
        >
          Sign Up
        </p>
      </div>
