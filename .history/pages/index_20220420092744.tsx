...
{/* Main page*/}
 ...
 {/*left*/}
  <div className="px-10 space-y-5">
     ...
     <h2 className="text-xl">It's time to shape your thought and learn something the best way, here we add all necessary information you may need to get started as a <span className="text-gray-800 hover:text-amber-400 cursor-pointer">business</span> person</h2>
