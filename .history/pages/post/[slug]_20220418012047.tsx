  ...
  return (
    ...
    <form className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
        ...
        <label className="block mb-5">
            ...
            <input {...register("email", {required: true}) } className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-amber-200 outline-none focus:ring" type="text"  placeholder="eg.example@xml.com"/>
        </label>
        <label className="block mb-5">
