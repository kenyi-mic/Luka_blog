  ...
  return (
    ...
    <form className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
        ...
        <label className="block mb-5">
            ...
            <input className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-amber-600 " type="text"  placeholder="eg. John Doe"/>
        </label>
        <label className="block mb-5">
            <span className="text-gray-700">Email</span>
            <input className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-amber-600 " type="text"  placeholder="eg.example@xml.com"/>
        </label>
        <label className="block mb-5">
