  ...
  return (
    ...
    <form className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
        ...
        <label className="block mb-5">
            ...
            <textarea  className="shadow border rounded py-2 px-3 form-textarea mt-1 block w-full ring-amber-600 outline-none focus:ring" placeholder="Write your text here" rows={8}/>
        </label>
    </form>
    </main>
  )
