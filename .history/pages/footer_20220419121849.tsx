    ...
    <div className="bg-blue-900">
      ...
      <div className=" text-gray-400 ">
       ...
       <div className=" text-gray-400 ">
        ...
        <h4 className="flex "><img className="h-6 w-6 mr-2 items-center justify-center pt-2" src="/medium.svg" alt="" />Medium</h4>
        <h4><TelegramIcon/>Telegram</h4>
        <h4 className="flex"><img className="h-4 w-4 mr-2 items-center justify-center pt-2" src="/discord.svg" alt="" />Discord</h4>
